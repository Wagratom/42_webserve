...
#    Updated: 2023/06/26 13:05:31 by wwallas-         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SOURCE		=	auxiliares.cpp port.cpp server_name.cpp tester.cpp parser_serve.cpp \
				...
				responseClientDELETE.cpp generateListFiles.cpp readConfigurationFile.cpp\
				saveLocationInfos.cpp getErrosPage.cpp init_Server.cpp
