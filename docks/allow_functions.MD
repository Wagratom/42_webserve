...
* `valor de retnorno` Em caso de sucesso, o PID do processo filho é retornado no processo pai, e 0 é retornado no processo filho. Em caso de falha, -1 é retornado no processo pai, nenhum processo filho é criado, e errno é definido para indicar o erro.
